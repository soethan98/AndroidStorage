...
import com.soethan.androidstorage.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadPhotosFromInternalStorageIntoRecyclerView() {
        lifecycleScope.launch {
            val photos = loadsPhotoFromInternalStorage()
    ...
    private suspend fun loadsPhotoFromInternalStorage(): List<InternalStoragePhoto> {
